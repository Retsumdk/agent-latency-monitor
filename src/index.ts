...
program.name("agent-latency-monitor").description("Real-time tracking of agent response latency across different LLM providers with anomaly detection").version("1.0.0")
